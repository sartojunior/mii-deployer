...
import org.asem.eclipse.mii.model.abs.IShape;
...
public class ConnectionReconnectCommand extends Command {
	...
	private AbstractModelShape newSource;
	/** The new target endpoint. */
	private AbstractModelShape newTarget;
	/** The original source endpoint. */
	private final AbstractModelShape oldSource;
	/** The original target endpoint. */
	private final AbstractModelShape oldTarget;
    ...
    private boolean checkSourceReconnection() {
		...
		if (oldTarget != null && !((IShape)oldTarget).allowConnectFrom(newSource))
            return false;
	...
	private boolean checkTargetReconnection() {
		...
		if (newTarget != null && !((IShape)newTarget).allowConnectFrom(oldSource))
            return false;
        
        if (oldSource != null && !((IShape)oldSource).canConnectTo(newTarget))
            return false;
	 ...
	 */
	public void setNewSource(AbstractModelShape connectionSource) {
	 ...
	 */
	public void setNewTarget(AbstractModelShape connectionTarget) {
